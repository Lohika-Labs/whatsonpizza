...
python3 /usr/local/lib/python3.6/site-packages/mxnet/tools/im2rec.py --resize 250 --quality 90 --num-thread 16 categorized-val large_pruned/orig/
python3 /usr/local/lib/python3.6/site-packages/mxnet/tools/im2rec.py --resize 250 --quality 90 --num-thread 16 categorized-train large_pruned/train/